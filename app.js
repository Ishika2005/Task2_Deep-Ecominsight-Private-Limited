...
async function extractDataFromPDF(pdfData) {
    try {
        ...
        // Additional data extraction functions
        const productTitle = "Unique Blood Pressure";
        const hsn = "901890";
        const taxableValue = "Rs.1013.3";
        const discount = "Rs.0.00";
        const taxes = "IGST @12.0% :Rs.121";
